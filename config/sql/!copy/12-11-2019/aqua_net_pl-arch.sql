...
--
-- Host: 127.0.0.1:3306
-- Czas generowania: 12 Lis 2019, 13:00
...
CREATE TABLE IF NOT EXISTS `im_form` (
  ...
  `receive` varchar(128) COLLATE utf8_polish_ci DEFAULT '',
...
(21, 0, 'BWT', '', 'logo-68c5c8915e85ab7dc6bb59a02731f500.jpg', 'on', NULL, '2019-11-12 13:34:48', '2019-11-12 13:34:48'),
...
(117, 29, 27, 0, 'aco', 'ACO', NULL, '', '', '', '', 1, 'on', '', '2019-11-12', '2019-11-12 12:02:19', '2019-11-12 12:24:04'),
(118, 29, 27, 0, 'afriso', 'Afriso', NULL, '', '', '', '', 2, 'on', '', '2019-11-12', '2019-11-12 12:26:14', '2019-11-12 13:45:23'),
...
(120, 29, 27, 0, 'białogon', 'Białogon', NULL, '', '', '', '', 3, 'on', '', '2019-11-12', '2019-11-12 13:45:49', '2019-11-12 13:53:35'),
(121, 29, 27, 0, 'bwt', 'BWT', NULL, '', '', '', '', 4, 'on', '', '2019-11-12', '2019-11-12 13:54:13', '2019-11-12 13:56:21');
...
CREATE TABLE IF NOT EXISTS `im_object_file` (
  ...
  KEY `object_id` (`object_id`),
  KEY `file_id` (`file_id`)
) ENGINE=InnoDB AUTO_INCREMENT=391 DEFAULT CHARSET=utf8 COLLATE=utf8_polish_ci;
...
CREATE TABLE IF NOT EXISTS `im_section_object` (
  ...
  KEY `object_id` (`object_id`)
) ENGINE=InnoDB AUTO_INCREMENT=1165 DEFAULT CHARSET=utf8 COLLATE=utf8_polish_ci;
...
(29, 'Dostawca', 'col-12 p-1', '', '2019-11-12 12:00:12', '2019-11-12 12:48:56');
...
(55, 29, 1, 'col-12 col-lg-2 text-center pt-2', 'badge badge-secondary', 2, '', '2019-11-12 12:00:49', '2019-11-12 12:53:25'),
(56, 29, 6, 'col-12 col-lg-5 text-center', '', 3, 'Bezpośrednio karta katalogowa', '2019-11-12 12:01:09', '2019-11-12 12:55:15'),
(57, 29, 4, 'col-12 col-lg-5', '', 1, 'Logo', '2019-11-12 12:01:14', '2019-11-12 12:45:36');
